...
def main():
    ...
    elif repository_type == "json files":
        client_repository = ClientJSONFileRepository(clients_repository_file_name)
        movie_repository = MovieJSONFileRepository(movies_repository_file_name)
        rental_repository = RentalJSONFileRepository(rentals_repository_file_name)
