...
from services.undoRedoService import UndoServiceException
...
class UI:
    ...
    def __display_client_menu():
        ...
        print("[7] Undo.")
        print("[8] Redo.")
        print("[9] Exit client menu.")
        print()

    @staticmethod
    def __display_movie_menu():
        print()
        ...
        print("[9] Undo.")
        print("[10] Redo.")
        print("[11] Exit movie menu.")
        print()

    @staticmethod
    def __display_rental_menu():
        print()
                ...
                while True:
                    ...
                    try:
                        if user_operation_command == '1':
                            ...
                            self.__ui_redo()
                        elif user_operation_command == '11':
                            break
                        else:
                            print("Not a valid number option. Choose between 1 and 5.")
                    except RepositoryException as repository_error:
