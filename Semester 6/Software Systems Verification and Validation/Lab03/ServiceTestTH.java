...
class ServiceTest {
    ...
    @Test
    void WBTTest_saveAssignment__CorrectIDValidDescriptionValidDeadlineValidStartline__Valid() {
        String id = "asdf";
    ...
    @Test
    void WBTTest_saveAssignment__CorrectIDEmptyDescriptionValidDeadlineValidStartline__Invalid() {
        String id = "asdf";
        String descriere = "";
        int deadline = 10;
        int startline = 5;
        assertEquals(0, service.saveTema(id, descriere, deadline, startline));
    }

    @Test
    void WBTTest_saveAssignment__EmptyIDValidDescriptionValidDeadlineValidStartline__Invalid() {
        String id = "";
        String descriere = "Descriere";
        int deadline = 10;
        int startline = 5;
    ...
    @Test
    void WBTTest_saveAssignment__CorrectIDValidDescriptionValidDeadlineNegativeStartline__Invalid() {
        String id = "asdf";
        String descriere = "Descriere";
        int deadline = 5;
        int startline = -2;
    ...
    @Test
    void WBTTest_saveAssignment__CorrectIDValidDescriptionTooLargeDeadlineValidStartline__Invalid() {
        String id = "asdf";
        String descriere = "Descriere";
        int deadline = 15;
        int startline = 2;
