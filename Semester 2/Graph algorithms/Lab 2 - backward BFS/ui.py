...
class UI:
    ...
    def find_lowest_length_path(self):
        ...
        shortest_path = backward_bfs(self.__available_graphs[self.__current_graph], destination_vertex, source_vertex)

        if len(shortest_path) == 0:
            print("There's no such path.")
            return

        print("The searched path is:")
        print(shortest_path)

        print(f"Its length is {len(shortest_path) - 1}.")
    ...
    def print_menu():
        print("\n"
              ...
              "[21] Lowest length path, by using a backward breadth-first search.\n"
              "[0] Exit."
              )
    ...
    def start_program(self):
        dictionary_with_commands = {"1": self.create_empty_directed_graph, "2": self.create_random_directed_graph,
                                    ...
                                    "21": self.find_lowest_length_path
                                    }
