...
public class LogicalExpression implements ProgramExpression {
    ...
    public Value evaluate(MyiDictionary<String, Value> table, MyiHeap heap) throws MyException {
        ...
        BoolValue firstBoolean = (BoolValue) this.firstExpression;
        BoolValue secondBoolean = (BoolValue) this.secondExpression;
    ...
    public ProgramExpression createDeepCopy() {
        return new LogicalExpression(this.firstExpression, this.secondExpression, this.operation);
    }
